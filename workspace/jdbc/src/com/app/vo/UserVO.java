...
public class UserVO {
	...
	public String toString() {
		return "UserVO [userId=" + userId + ", userIdentification=" + userIdentification + ", userPassword="
				...
				+ userBirth + ", userRecommenerId=" + userRecommenerId + ", userStatus=" + userStatus + "]";
	}
	...
	public UserVO(String userIdentification, String userPassword, String userName, String userPhone,
			String userNickname, String userEmail, String userAddress, String userBirth, String userRecommenerId) {
		super();
